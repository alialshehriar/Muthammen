      ...
      <div className="info-panel">
        <div className="info-header">
          ...
          <p className="info-subtitle">
            {displayLocation ? 'مرر على العلامات لعرض التفاصيل' : 'حدد موقعاً على الخريطة'}
          </p>
        </div>
        ...
        {displayLocation ? (
          <div className="location-details">
            ...
            <div className="price-section">
              ...
              <div className="price-value">{displayLocation.price.toLocaleString()} ريال</div>
            </div>
            ...
            <div className="details-grid">
              ...
              <div className="detail-card">
                ...
                <div className="detail-value rating">
                  <span className="stars">{'★'.repeat(Math.round(displayLocation.rating))}</span>
            ...
            <div className="facilities-section">
              ...
              <div className="facilities-list">
                {displayLocation.facilities.map((facility, index) => (
            ...
            <div className="coordinates-section">
              <div className="section-title">الإحداثيات</div>
              <div className="coordinates">
                <div className="coord-item">
                  <span className="coord-label">خط الطول:</span>
                  <span className="coord-value">{displayLocation.coords[0].toFixed(4)}</span>
                </div>
                <div className="coord-item">
                  <span className="coord-label">خط العرض:</span>
                  <span className="coord-value">{displayLocation.coords[1].toFixed(4)}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="empty-state">
            ...
            <p>اختر موقعاً على الخريطة لعرض التفاصيل</p>
          </div>
        )}
      </div>
